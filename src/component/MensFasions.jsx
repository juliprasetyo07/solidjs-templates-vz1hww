...
export default function MensFasions() {
  return (
    <section class="sm:flex pb-16 ">
      <div class="pl-3 bg-white sm:w-1/4 mr-5">
      <h2 class="text-xl font-bold mb-8">Men's Fashion</h2>
        ...
        <h1>Drone</h1>
        <h1>Apple</h1>
        <a href="#" class="grid grid-cols-2 mt-8 ">  <h2 class="text-xl">Browse All </h2> <p class="my-auto"><FaSolidArrowRightLong /></p></a>
      </div>
